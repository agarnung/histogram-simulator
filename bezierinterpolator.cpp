...
void BezierInterpolator::InterpolateBezier(const QPointF &p1, const QPointF &p2, const QPointF &p3, const QPointF &p4, QPolygonF &interpolatedPoints, unsigned level) const
{
...
void BezierInterpolator::CalculateBoorNet(const QVector<QPointF *> &controlPoints, const QVector<qreal> &knotVector, QPolygonF &boorNetPoints) const
{
