...
QT_BEGIN_NAMESPACE
namespace Ui { class HistogramSimulatorUI; }
QT_END_NAMESPACE

class ControlPoint;
class HistogramSimulatorUI;
class ScrollableMessageBox;

class ControlPoint : public QGraphicsEllipseItem
{
	public:
		ControlPoint(qreal x, qreal y, qreal width, qreal height, HistogramSimulatorUI* histogramSimulatorUI, QGraphicsItem* parent = nullptr, QString name = "p");
...
class HistogramSimulatorUI : public QWidget
{
    Q_OBJECT

    public:
		explicit HistogramSimulatorUI(QWidget* parent = nullptr);
		~HistogramSimulatorUI();
	...
	private:
		Ui::HistogramSimulatorUI* mUi = nullptr;
